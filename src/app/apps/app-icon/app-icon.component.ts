 ...
 * (dropped from the npm package) — path/hex sourced from the same MIT-licensed
 * simple-icons dataset at an earlier published version, not hand-typed.
 */
const VSCODE_PATH =
...
export class AppIconComponent {
  ...
  protected readonly figmaPath = siFigma.path;
  protected readonly figmaHex = computed(() => `#${siFigma.hex}`);
  protected readonly youtubePath = siYoutube.path;
}
